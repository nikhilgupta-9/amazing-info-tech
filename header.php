            ...
            <div class="header-top-wrap">
                <div class="header-top-left">
                    <div class="header-top-social">
                        <span>Follow Us:</span>
                        <a href="https://www.facebook.com/AmazingInfotech.Official" target="_blank"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/amazing_infotech/" target="_blank"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.youtube.com/@AmazingInfotechOfficial" target="_blank"><i class="fab fa-youtube"></i></a>
                        <a href="https://www.linkedin.com/company/amazing-infotech-pvt-ltd-india/" target="_blank"><i class="fa-brands fa-linkedin"></i></a>
                ...
                <div class="header-top-right">
                    <div class="header-top-contact">
                        <ul>
                            ...
                            <li>
                                <div class="header-top-contact-info">
                                    <a href="mailto:sales@amazinginfotech.in"><i class="far fa-envelope"></i> sales@amazinginfotech.in</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    <div class="offcanvas-header">
                        <a href="index.php" class="offcanvas-brand" id="offcanvasNavbarLabel">
                            <img src="admin/uploads/logo/<?php echo $result['logo_image'];?>" alt="Amazing Infotech Logo">
                        </a>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1">
                           ...
                           <li class="menu-icon">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?=$site?>assets/certificate_merged.pdf" target="_blank">Our Certificate</a></li>
